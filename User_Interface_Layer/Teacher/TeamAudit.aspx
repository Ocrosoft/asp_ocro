<%@ Page Title="团队审核" Language="C#" MasterPageFile="~/UIL.Master" AutoEventWireup="true" CodeBehind="TeamAudit.aspx.cs" Inherits="User_Interface_Layer.Teacher.TeamAudit" %>
                ...
                <form runat="server" id="usersForm">
                    <div class="table-responsive">
                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"
                            SelectMethod="queryAuditWaiting"
                            TypeName="Business_Logic_Layer.BLL_Team">
                            <SelectParameters>
                                <asp:SessionParameter Name="TeaID" SessionField="loginSession" Type="String" />
                            </SelectParameters>
